!(function (e, t) {
  function r(e, t) {
    ...
    function s(e, t, r) {
      for (var n, i = t.split("["), a = 0, o = i.length; o - 1 > a; ++a)
        (n = i[a].replace(/\]$/, "")), (e = e[n] || (e[n] = {}));
      e[i[a].replace(/\]$/, "")] = r;
    }
    var l = {},
      c = e.replace(/^.*?\?/, "");
    return "" === c
      ? l
      : (c.split(/&(?:amp;)?/).forEach(function (e) {
          var i = e.split("="),
            a = r(i[0]),
            c = n(i[1]) ? r(i[1]) : !0;
          (c = !n(t) || t ? o(c) : c),
            "]" === a.slice(-1) ? s(l, a, c) : (l[a] = c);
        }),
        l);
  }
  e[t] = r;
  ...
  (function (e, t) {
    ...
    function s(e, t) {
      t = t || {};
      for (var r in e)
        n(t[r]) ? o(e[r]) && o(t[r]) && (t[r] = s(e[r], t[r])) : (t[r] = e[r]);
      return t;
    }
    function l(e, t, r) {
    ...
    function c(e, r, i) {
      if (
        ((e = t.createElement(e)), n(r) && "" !== r && (e.innerHTML = r), o(i))
      )
    ...
    function m(e, t) {
      return (
        (e = (e + "").split(/[?&#]/)[0].replace(/\/+$/, "")),
        n(t) && (e = e.replace(/\.[\w-]+$/, t ? "." + t : "")),
        e
      );
    }
    function g(e) {
      return a(e)
        ? ("file:" === E.protocol ? "https:" : "") +
            "//www.blogger.com/feeds/" +
            e +
            "/posts/summary"
        : m(e) + "/feeds/posts/summary";
    }
    function y(e, t, r) {
      var n = /\.css$/i.test(m(e)),
        i = c(
          n ? "link" : "script",
          "",
          s(n ? { href: e, rel: "stylesheet" } : { src: e }, r)
        );
      return (
        i.readyState
          ? (i.onreadystatechange = function () {
              ("loaded" === i.readyState || "complete" === i.readyState) &&
                ((i.onreadystatechange = null), t && t(i));
            })
          : t && l(i, "load", t),
        d(z, i, z.firstChild),
        i
      ...
      if (!D.container && X.parentNode) {
        ...
        u(X, J + "-float"),
          (X.style.cssText =
            ...
            ";color:" +
            $("color") +
            ";position:fixed;z-index:9999;top:" +
            (n + o) +
            "px;left:" +
            i +
            "px;width:" +
    ...
    function q(e, t) {
      ...
      d(n, Z),
        r[0]
          ? ((rt.style.display = I > 1 ? "" : "none"),
            (nt.style.display = Q > r[0] ? "none" : ""),
            (et.innerHTML = r[1]),
            d(n, et))
          : ((n.innerHTML =
              '<p class="' +
    ...
    var L = e.q2o,
      ...
      R = {
        ...
        query: { alt: "json", orderby: "updated" },
      },
      z = t.head,
      D = s(R, L(M.src)),
    ...
    if (P) {
      ...
      l(e, "scroll", b),
        ...
        (e["_" + B] = function (e) {
                ...
                if (((str = ""), t)) {
                  if (b) {
                    var r,
                      n,
                      i,
                      o = "media$thumbnail" in e;
                    b === !0 && (b = 60),
                      a(b)
                        ? ((r = n = b + "px"), (b = "s" + b + "-c"))
                        : (i = /^s(\d+)(\-[cp])?$/.exec(b))
                        ? ((r = i[1] + "px"), (n = i[2] ? i[1] + "px" : "auto"))
                        : (i = /^w(\d+)\-h(\d+)(\-[cp])?$/.exec(b)) &&
                          ((r = i[1] + "px"), (n = i[2] + "px")),
                      (str +=
                        '<p class="' +
                        ...
                        '">'),
                      (str += o
                        ? '<img class="lazyload" alt="" src="' +
                          e.media$thumbnail.url.replace(
                            /\/s\d+(\-c)?\//g,
                            "/" + b + "/"
                          ) +
                          ...
                          n +
                          ';">'
                        : '<span class="img lazyload" style="display:block;width:' +
                          r +
                          ";height:" +
                          n +
                          ';">'),
          ...
          p(it),
            (rt.style.display = I > 1 ? "" : "none"),
            (nt.style.display = Q > k ? "none" : ""),
            d(tt, rt),
            d(tt, t.createTextNode(" ")),
            d(tt, nt);
          var o = X.children[0];
          if ((d(o, Z), d(o, et), d(o, tt), b)) {
            var N = et.getElementsByTagName("img"),
              ...
              C = function () {
                f(this.parentNode, "loading"),
                  v(this, "load.asset", [this.src]);
              };
            for (n = 0, i = N.length; i > n; ++n)
              l(N[n], "error", S), l(N[n], "load", C);
          }
          x() &&
            y(
              g("6243576702872104792") +
                h(
                  s(D.query, {
                    callback: "_" + B + "_",
                    "max-results": 21,
        ...
        (e["_" + B + "_"] = function (e) {
          ...
          (t = t[Math.floor(Math.random() * t.length)]),
            (t = G(t)) && (u(t, "ad"), d(et, t, et.firstChild)),
            v(t, "load.ad", [e]);
        }),
        M.id || (M.id = J + "-js"),
        u(M, J + "-js");
